      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="page-title flex items-center gap-2.5">
            <Wrench className="h-7 w-7 text-muted-foreground" /> My Assigned Tickets
          </h1>
          <p className="page-subtitle">Your claimed and assigned repair jobs.</p>
        </div>
        <Button onClick={fetchMyTickets} variant="outline" size="sm" className="rounded-xl border-border/80">
      ...
      {!loading && tickets.length === 0 && (
        <Card className="border-dashed border-2">
          <CardContent className="py-20 flex flex-col items-center justify-center text-center gap-4">
            ...
            <div>
              <h3 className="font-semibold text-lg">No Tickets Assigned</h3>
              <p className="text-sm text-muted-foreground mt-1">
                You have no active maintenance tickets assigned to you. Go to All Tickets to claim one!
              </p>
            </div>
          </CardContent>
        </Card>
                  ...
                  <div className="space-y-2 flex-1">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-xs text-muted-foreground pt-1">
                      ...
                      <div>
                        ...
                        <span className="text-foreground font-semibold capitalize">{ticket.priority ?? "low"}</span>
                      </div>
                      <div>
