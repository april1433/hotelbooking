      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="page-title flex items-center gap-2.5">
            <Wrench className="h-7 w-7 text-muted-foreground" /> All Tickets Queue
          </h1>
          <p className="page-subtitle">Full list of all reported maintenance issues and requests.</p>
        </div>
      ...
      {!loading && tickets.length === 0 && (
        <Card className="border-dashed border-2">
          <CardContent className="py-20 flex flex-col items-center justify-center text-center gap-4">
            ...
            <div>
              <h3 className="font-semibold text-lg">No Tickets Filed</h3>
              <p className="text-sm text-muted-foreground mt-1">Everything is in perfect working order.</p>
            </div>
          </CardContent>
        </Card>
      )}
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                  ...
                  <div className="flex flex-wrap gap-2.5 shrink-0 self-end md:self-center">
                    ...
                    {ticket.status === "in_progress" && (
                      ...
                      >
                        <CheckCircle2 className="h-3.5 w-3.5" /> Settle/Resolve
                      </Button>
                    )}
