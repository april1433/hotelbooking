...
export const DEFAULT_HOTEL = DEFAULT_HOTELS[0];
...
export const DEFAULT_ROOM_TYPES = [
  ...
  // Pilgrims Hotel
  {
    ...
    hotel_id: "11111111-0000-0000-0000-000000000002",
    name: "Pilgrims Deluxe Room",
    slug: "pilgrims-deluxe-room",
    description: "Comfortable and elegant deluxe room with modern amenities.",
    base_price: 3500,
    max_occupancy: 2,
    max_adults: 2,
    max_children: 1,
    bed_type: "Queen",
    size_sqm: 32,
    hotels: { name: "Pilgrims Hotel" },
    is_active: true,
  },
  {
    id: "b2222222-2222-2222-2222-222222222222",
    hotel_id: "11111111-0000-0000-0000-000000000002",
    name: "Pilgrims Superior Suite",
    slug: "pilgrims-superior-suite",
    description: "Spacious suite with city views and premium lounge comfort.",
    base_price: 5200,
    max_occupancy: 3,
    max_adults: 2,
    max_children: 1,
  ...
  // Bay Plaza Hotel
  {
    ...
    hotel_id: "11111111-0000-0000-0000-000000000003",
    name: "Bay View Suite",
    slug: "bay-view-suite",
    description: "Stunning bay-facing suite with private balcony and sunset panorama.",
    base_price: 7500,
    max_occupancy: 3,
    max_adults: 2,
    max_children: 1,
    bed_type: "King",
    size_sqm: 50,
    hotels: { name: "Bay Plaza Hotel" },
    is_active: true,
  },
  {
    id: "bb222222-2222-2222-2222-222222222222",
    hotel_id: "11111111-0000-0000-0000-000000000003",
    name: "Plaza Executive Room",
    slug: "plaza-executive-room",
    description: "Modern executive room tailored for business and relaxation.",
    base_price: 4600,
    max_occupancy: 2,
    max_adults: 2,
    max_children: 0,
  ...
  // Mardale Hotel
  {
    ...
    hotel_id: "11111111-0000-0000-0000-000000000004",
    name: "Mardale Deluxe Room",
    slug: "mardale-deluxe-room",
    description: "Elegantly furnished deluxe room in the heart of the city.",
    base_price: 3800,
    max_occupancy: 2,
    max_adults: 2,
    max_children: 1,
    bed_type: "King",
    size_sqm: 35,
    hotels: { name: "Mardale Hotel" },
    is_active: true,
  },
  {
    id: "c2222222-2222-2222-2222-222222222222",
    hotel_id: "11111111-0000-0000-0000-000000000004",
    name: "Mardale Executive Suite",
    slug: "mardale-executive-suite",
    description: "Premium executive suite with dedicated work area and lounge.",
    base_price: 6800,
    max_occupancy: 3,
    max_adults: 2,
    max_children: 1,
  ...
  // GV Hotel
  {
    ...
    hotel_id: "11111111-0000-0000-0000-000000000005",
    name: "GV Deluxe Double",
    slug: "gv-deluxe-double",
    description: "Clean and comfortable deluxe double room with modern furnishings.",
    base_price: 2800,
    max_occupancy: 2,
    max_adults: 2,
    max_children: 1,
  ...
  },
  {
    ...
    name: "GV Family Room",
    slug: "gv-family-room",
    description: "Spacious family room with extra beds and child-friendly amenities.",
    base_price: 3500,
    max_occupancy: 4,
    max_adults: 2,
    max_children: 2,
  ...
  // Lex Hotel
  {
    ...
    hotel_id: "11111111-0000-0000-0000-000000000006",
    name: "Lex Classic Room",
    slug: "lex-classic-room",
    description: "Timeless classic room with refined interiors and all essentials.",
    base_price: 3200,
    max_occupancy: 2,
    max_adults: 2,
    max_children: 1,
    bed_type: "Queen",
    size_sqm: 30,
    hotels: { name: "Lex Hotel" },
    is_active: true,
  },
  {
    id: "e2222222-2222-2222-2222-222222222222",
    hotel_id: "11111111-0000-0000-0000-000000000006",
    name: "Lex Junior Suite",
    slug: "lex-junior-suite",
    description: "Comfortable junior suite with separate seating area.",
    base_price: 5500,
    max_occupancy: 3,
    max_adults: 2,
    max_children: 1,
...
export const DEFAULT_ROOMS = [
  ...
  // Pilgrims Hotel
  { id: "b0000000-0000-0000-0000-000000001101", hotel_id: "11111111-0000-0000-0000-000000000002", room_number: "101", floor_number: 1, room_type_id: "b1111111-1111-1111-1111-111111111111", status: "available", cleaning_status: "clean", is_active: true, room_types: { name: "Pilgrims Deluxe Room", base_price: 3500, max_occupancy: 2 }, hotels: { name: "Pilgrims Hotel" } },
  { id: "b0000000-0000-0000-0000-000000001102", hotel_id: "11111111-0000-0000-0000-000000000002", room_number: "102", floor_number: 1, room_type_id: "b1111111-1111-1111-1111-111111111111", status: "available", cleaning_status: "clean", is_active: true, room_types: { name: "Pilgrims Deluxe Room", base_price: 3500, max_occupancy: 2 }, hotels: { name: "Pilgrims Hotel" } },
  { id: "b0000000-0000-0000-0000-000000001201", hotel_id: "11111111-0000-0000-0000-000000000002", room_number: "201", floor_number: 2, room_type_id: "b2222222-2222-2222-2222-222222222222", status: "available", cleaning_status: "clean", is_active: true, room_types: { name: "Pilgrims Superior Suite", base_price: 5200, max_occupancy: 3 }, hotels: { name: "Pilgrims Hotel" } },
  // Bay Plaza Hotel
  { id: "b0000000-0000-0000-0000-000000002101", hotel_id: "11111111-0000-0000-0000-000000000003", room_number: "101", floor_number: 1, room_type_id: "bb111111-1111-1111-1111-111111111111", status: "available", cleaning_status: "clean", is_active: true, room_types: { name: "Bay View Suite", base_price: 7500, max_occupancy: 3 }, hotels: { name: "Bay Plaza Hotel" } },
  { id: "b0000000-0000-0000-0000-000000002102", hotel_id: "11111111-0000-0000-0000-000000000003", room_number: "102", floor_number: 1, room_type_id: "bb222222-2222-2222-2222-222222222222", status: "available", cleaning_status: "clean", is_active: true, room_types: { name: "Plaza Executive Room", base_price: 4600, max_occupancy: 2 }, hotels: { name: "Bay Plaza Hotel" } },
  // Mardale Hotel
  { id: "b0000000-0000-0000-0000-000000003101", hotel_id: "11111111-0000-0000-0000-000000000004", room_number: "101", floor_number: 1, room_type_id: "c1111111-1111-1111-1111-111111111111", status: "available", cleaning_status: "clean", is_active: true, room_types: { name: "Mardale Deluxe Room", base_price: 3800, max_occupancy: 2 }, hotels: { name: "Mardale Hotel" } },
  { id: "b0000000-0000-0000-0000-000000003201", hotel_id: "11111111-0000-0000-0000-000000000004", room_number: "201", floor_number: 2, room_type_id: "c2222222-2222-2222-2222-222222222222", status: "available", cleaning_status: "clean", is_active: true, room_types: { name: "Mardale Executive Suite", base_price: 6800, max_occupancy: 3 }, hotels: { name: "Mardale Hotel" } },
  // GV Hotel
  { id: "b0000000-0000-0000-0000-000000004101", hotel_id: "11111111-0000-0000-0000-000000000005", room_number: "101", floor_number: 1, room_type_id: "d1111111-1111-1111-1111-111111111111", status: "available", cleaning_status: "clean", is_active: true, room_types: { name: "GV Deluxe Double", base_price: 2800, max_occupancy: 2 }, hotels: { name: "GV Hotel" } },
  { id: "b0000000-0000-0000-0000-000000004201", hotel_id: "11111111-0000-0000-0000-000000000005", room_number: "201", floor_number: 2, room_type_id: "d2222222-2222-2222-2222-222222222222", status: "available", cleaning_status: "clean", is_active: true, room_types: { name: "GV Family Room", base_price: 3500, max_occupancy: 4 }, hotels: { name: "GV Hotel" } },
  // Lex Hotel
  { id: "b0000000-0000-0000-0000-000000005101", hotel_id: "11111111-0000-0000-0000-000000000006", room_number: "101", floor_number: 1, room_type_id: "e1111111-1111-1111-1111-111111111111", status: "available", cleaning_status: "clean", is_active: true, room_types: { name: "Lex Classic Room", base_price: 3200, max_occupancy: 2 }, hotels: { name: "Lex Hotel" } },
  { id: "b0000000-0000-0000-0000-000000005201", hotel_id: "11111111-0000-0000-0000-000000000006", room_number: "201", floor_number: 2, room_type_id: "e2222222-2222-2222-2222-222222222222", status: "available", cleaning_status: "clean", is_active: true, room_types: { name: "Lex Junior Suite", base_price: 5500, max_occupancy: 3 }, hotels: { name: "Lex Hotel" } },
];
